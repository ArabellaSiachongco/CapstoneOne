const justice = [
    {
        id: "justice_human_rights",
        title: "Social Justice and Human Rights",
        subtitle: "ARTICLE XIII",
        sections: [
            {
                name: "Section 1",
                paragraph: [
...
const agrarian = [
    {
        id: "agrarian_reform",
        title: "Agrarian and Natural Resources Reform",
        sections: [
            {
                name: "Section 4",
                paragraph:
...
const heal = [
    {
        ...
        sections: [
            {
                name: "Section 11",
                paragraph: "The State shall adopt an integrated and comprehensive approach to health development which shall endeavor to make essential goods, health and other social services available to all the people at affordable cost. There shall be priority for the needs of the underprivileged sick, elderly, disabled, women, and children. The State shall endeavor to provide free medical care to paupers.",
            },
            {
                name: "Section 12",
                paragraph: "The State shall establish and maintain an effective food and drug regulatory system and undertake appropriate health manpower development and research, responsive to the country’s health needs and problems.",
            },
            {
                name: "Section 13",
                paragraph: "The State shall establish a special agency for disabled persons for rehabilitation, self-development and self-reliance, and their integration into the mainstream of society.",
            },
        ],
    },
];
...
const girls = [
    {
        ...
        sections: [
            {
                name: "Section 14",
                paragraph: "The State shall protect working women by providing safe and healthful working conditions, taking into account their maternal functions, and such facilities and opportunities that will enhance their welfare and enable them to realize their full potential in the service of the nation.",
            },
        ],
    },
];
...
const role = [
    {
        id: "people_orgs",
        title:"Role and Rights of People’s Organizations",
        sections: [
            {
                name: "Section 15",
                paragraph: [
            ...
            {
                name: "Section 16",
                paragraph: "The right of the people and their organizations to effective and reasonable participation at all levels of social, political, and economic decision-making shall not be abridged. The State shall, by law, facilitate the establishment of adequate consultation mechanisms.",
            },
        ],
    },
];
...
const human = [
    {
        ...
        sections: [
            ...
            {
                name: "Section 19",
                paragraph: "The Congress may provide for other cases of violations of human rights that should fall within the authority of the Commission, taking into account its recommendations.",
            },
        ],
    },
];

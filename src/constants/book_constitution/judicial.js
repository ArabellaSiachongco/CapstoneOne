const judicial = [
    {
        ...
        sections: [
            ...
            {
                name: "Section 3",
                paragraph: "The Judiciary shall enjoy fiscal autonomy. Appropriations for the Judiciary may not be reduced by the legislature below the amount appropriated for the previous year and, after approval, shall be automatically and regularly released.",
            },
            {
                name: "Section 4",
                paragraph:[
            ...
            {
                name: "Section 6",
                paragraph: "The Supreme Court shall have administrative supervision over all courts and the personnel thereof.",
            },
            {
                name: "Section 7",
                paragraph:[

const chapterNine = [
    {
        id: "enforcement",
        title: "Jurisdiction and Procedures for Enforcement of Rights",
        subtitle: "Chapter IX",
        sections: [
            {
                name: "Section 65",
                subtitle: "Primacy of Customary Laws and Practices.",
                paragraph: "When disputes involve ICCs/IPs, customary laws and practices shall be used to resolve the dispute.",
            },
            {
                name: "Section 66",
                subtitle: "Primacy of Customary Laws and Practices.",
                paragraph: "The NCIP, through its regional offices, shall have jurisdiction over all claims and disputes involving rights of ICCs/IPs: Provided, however, That no such dispute shall be brought to the NCIP unless the parties have exhausted all remedies provided under their customary laws. For this purpose, a certification shall be issued by the Council of Elders/Leaders who participated in the attempt to settle the dispute that the same has not been resolved, which certification shall be a condition precedent to the filing of a petition with the NCIP.",
            },
            {
                name: "Section 67",
                subtitle: "Appeals to the Court of Appeals.",
                paragraph: "Decisions of the NCIP shall be appealable to the Court of Appeals by way of a petition for review."
            },
            {
                name: "Section 68",
                subtitle: "Execution of Decisions, Awards, Orders.",
                paragraph: "Upon expiration of the period herein provided and no appeal is perfected by any of the contending parties, the Hearing Officer of the NCIP, on its own initiative or upon motion by the prevailing party, shall issue a writ of execution requiring the sheriff or the proper officer to execute final decisions, orders or awards of the Regional Hearing Officer of the NCIP.",
            },
            {
                name: "Section 69",
                subtitle: "Quasi-Judicial Powers of the NCIP.",
                sub_paragraph: "The NCIP shall have the power and authority:",
                paragraph: [

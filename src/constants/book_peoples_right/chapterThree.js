const chapterThree = [
    {
        ...
        sections: [
            {
                name: "Section 4",
                subtitle: "Concept of Ancestral Lands/Domains.",
                paragraph: "Ancestral lands/domains shall include such concepts of territories which cover not only the physical environment but the total environment including the spiritual and cultural bonds to the areas which the ICCs/IPs possess, occupy and use and to which they have claims of ownership.",
            },
            {
                name: "Section 5",
                subtitle: "Indigenous Concept of Ownership.",
                paragraph:
            ...
            {
                name: "Section 6",
                subtitle: "Composition of Ancestral Lands/Domains.",
                paragraph: "Ancestral lands and domains shall consist of all areas generally belonging to ICCs/IPs as referred under Sec. 3, items (a) and (b) of this Act.",
            },
            {
                name: "Section 7",
                subtitle: "Rights to Ancestral Domains.",
                paragraph: [
                    {
                        sub_paragraph: "The rights of ownership and possession of ICCs/IPs to their ancestral domains shall be recognized and protected. Such rights shall include:",
                        name: "a. Right of Ownership.",
                        paragraph: "The right to claim ownership over lands, bodies of water traditionally and actually occupied by ICCs/IPs, sacred places, traditional hunting and fishing grounds, and all improvements made by them at any time within the domains;",
                    },
                    {
                        name: "b. Right to Develop Lands and Natural Resources. 9",
                        paragraph: "Subject to Section 56 hereof, right to develop, control and use lands and territories traditionally occupied, owned, or used; to manage and conserve natural resources within the territories and uphold the responsibilities for future generations; to benefit and share the profits from allocation and utilization of the natural resources found therein; the right to negotiate the terms and conditions for the exploration of natural resources in the areas for the purpose of ensuring ecological, environmental protection and the conservation measures, pursuant to national and customary laws; the right to an informed and intelligent participation in the formulation and implementation of any project, government or private, that will affect or impact upon the ancestral domains and to receive just and fair compensation for any damages which they may sustain as a result of the project; and the right to effective measures by the government to prevent any interference with, alienation and encroachment upon these rights;",
                    },
                    {
                        name: "c. Right to Stay in the Territories",
                    ...
                    {
                        name: "d. Right in Case of Displacement",
                    ...
                    {
                        name: "e. Right to Regulate Entry of Migrants",
                        paragraph: "Right to regulate the entry of migrant settlers and organizations into the domains;",
                    },
                    {
                        name: "f. Right to Safe and Clean Air and Water.",
                        paragraph: "For this purpose, the ICCs/IPs shall have access to integrated systems for the management of their inland waters and air space;",
                    },
                    {
                        name: "g. Right to Claim Parts of Reservations",
                        paragraph: " The right to claim parts of the ancestral domains which have been reserved for various purposes, except those reserved and intended for common public welfare and service; and",
                    },
                    {
                        name: "h. Right to Resolve Conflict",
                        paragraph: " Right to resolve land conflicts in accordance with customary laws of the area where the land is located, and only in default thereof shall the complaints be submitted to amicable settlement and to the Courts of Justice whenever necessary.",
                    },
                ],
            },
            {
                name: "Section 8",
                subtitle: "Rights to Ancestral Lands.",
                paragraph: [
                    {
                        sub_paragraph: "The right of ownership and possession of the ICCs/IPs to their ancestral lands shall be recognized and protected.",
                        name: "Right to transfer land/property.",
                        paragraph: "Such right shall include the right to transfer land or property rights to/among members of the same ICCs/IPs, subject to customary laws and traditions of the community concerned.",
                    },
                    {
                        name: "Right to Redemption",
                        paragraph: "In cases where it is shown that the transfer of land/property rights by virtue of any agreement or devise, to a non-member of the concerned ICCs/IPs is tainted by the vitiated consent of the ICCs/IPs, or is transferred for an unconscionable consideration or price, the transferor ICC/IP shall have the right to redeem the same within a period not exceeding fifteen (15) years from the date of transfer.",
                    },
                ],
            },
            {
                name: "Section 9",
                subtitle: "Responsibilities of ICCs/IPs to their Ancestral Domains.",
                paragraph: [
                    {
                        sub_paragraph: "ICCs/IPs occupying a duly certified ancestral domain shall have the following responsibilities:",
                        name: "a. Maintain Ecological Balance.",
                        paragraph: " To preserve, restore, and maintain a balanced ecology in the ancestral domain by protecting the flora and fauna, watershed areas, and other reserves;",
                    },
                    {
                        name: "b. Restore Denuded Areas",
                        paragraph: "To actively initiate, undertake and participate in the reforestation of denuded areas and other development programs and projects subject to just and reasonable remuneration; and",
                    },
                    {
                        name: "c. Observe Laws",
                        paragraph: "To observe and comply with the provisions of this Act and the rules and regulations for its effective implementation.",
                    },
                ],
            },
            {
                name: "Section 10",
                subtitle: "Unauthorized and Unlawful Intrusion.",
                paragraph: "Unauthorized and unlawful intrusion upon, or use of any portion of the ancestral domain, or any violation of the rights hereinbefore enumerated, shall be punishable under this law. Furthermore, the Government shall take measures to prevent non-ICCs/IPs from taking advantage of the ICCs/IPs customs or lack of understanding of laws to secure ownership, possession of land belonging to said ICCs/IPs.",
            },
            {
                name: "Section 11",
                subtitle: "Recognition of Ancestral Domain Rights.",
                paragraph: "The rights of ICCs/IPs to their ancestral domains by virtue of Native Title shall be recognized and respected. Formal recognition, when solicited by ICCs/IPs concerned, shall be embodied in a Certificate of Ancestral Domain Title (CADT), which shall recognize the title of the concerned ICCs/IPs over the territories identified and delineated.",
            },
            {
                name: "Section 12",
                subtitle: "Option to Secure Certificate of Title Under Commonwealth Act 141, as amended, or the Land Registration Act 496.",
                paragraph: [

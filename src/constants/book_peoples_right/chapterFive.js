const chapterFive = [
    {
        ...
        sections: [
            {
                name: "Section 21",
                subtitle: "Equal Protection and Non-discrimination of ICCs/IPs.",
                paragraph:[
                    "Consistent with the equal protection clause of the Constitution of the Republic of the Philippines, the Charter of the United Nations, the Universal Declaration of Human Rights including the Convention on the Elimination of Discrimination Against Women and International Human Rights Law, the State shall, with due recognition of their distinct characteristics and identity, accord to the members of the ICCs/IPs the rights, protections and privileges enjoyed by the rest of the citizenry. ",
                    "It shall extend to them the same employment rights, opportunities, basic services, educational and other rights and privileges available to every member of the society. Accordingly, the State shall likewise ensure that the employment of any form of force or coercion against ICCs/IPs shall be dealt with by law.",
            ...
            {
                name: "Section 17",
                subtitle: "Freedom from Discrimination and Right to Equal Opportunity and Treatment.",
                paragraph:[
            ...
            {
                name: "Section 24",
                subtitle: "Unlawful Acts Pertaining to Employment.",
                sub_paragraph: "It shall be unlawful for any person:",
                paragraph: [

        ...
        <div>
            ...
            <table className="mt-5 w-full border-collapse border border-gray-200">
                <tbody>
                    ...
                    <tr>
                        <td className={`${styles.appointmentSubTextLower} border border-gray-300 p-3`}>
                            2. The appointment must be named after the requester who will personally apply at the Magalgalit Law Office.
                        </td>
                    </tr>
                    <tr>
                        <td className={`${styles.appointmentSubTextLower} border border-gray-300 p-3`}>
                            3. Be at the Magalgalit Law Office at least fifteen minutes before the appointment schedule.
                        </td>
                    </tr>
                    <tr>
                        <td className={`${styles.appointmentSubTextLower} border border-gray-300 p-3`}>
                            <label>
                                <input
                                    ...
                                    className="mr-2"
                                />
                                I agree to the collection and use of the data that I will provide through this form for the purpose of booking an appointment. I understand that the collection and use of this data, which may include personal and sensitive personal information, shall be in accordance with the Data Privacy Act of 2021.
                            </label>
                        </td>
                    </tr>
                </tbody>
